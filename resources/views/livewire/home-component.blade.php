<main id="main">
  <div class="container">
        ...
        @foreach ($sliders as $slide)
          <div class="item-slide">
                ...
                <div class="slide-info slide-1">
                  <h2 class="f-title"><b style="color: #fff">{{$slide->title}}</b></h2>
                  <span class="subtitle" style="color: #fff">{{$slide->subtitle}}</span>
                  <p class="sale-info" style="color: #fff">Only price: <span class="price">PHP {{$slide->price}}</span></p>
                  <a href="{{$slide->link}}" class="btn-link">Order Now</a>
                </div>
          </div>
        @endforeach
      </div>
    ...
    <div class="wrap-show-advance-info-box style-1">
      <h3 class="title-box">Latest Food</h3>
      <div class="wrap-top-banner">
        <a href="/shop" class="link-banner banner-effect-2">
          <figure><img src="{{ asset('assets/images/banner-food-6.jpg')}}" width="1170" height="240" alt=""></figure>
        </a>
      </div>
    ...
    <!--Product Categories-->
    <div class="wrap-show-advance-info-box style-1">
      <h3 class="title-box">Food Categories</h3>
      <div class="wrap-top-banner">
        <a href="#" class="link-banner banner-effect-2">
          <figure><img src="{{ asset('assets/images/banner-food-7.jpg')}}" width="1170" height="240" alt=""></figure>
        </a>
      </div>
      <div class="wrap-products">
        <div class="wrap-product-tab tab-style-1">
